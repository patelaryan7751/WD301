...
export default function PreviewLabeledInput(props: { id: number, label: string, type: string, placeholder: string, updateFieldCB: (value: string, id: number) => void, value: string }) {
    return (
